        ...
        <section class="articles-list mt-10 mb-3">
            ...
            <?php if (getPagePaths()[0] == 'articles'): ?>
                <div class="search-feature">
                    <form method="POST" action="/articles/search" class="text-center mt-7">
                        <input
                            type="text"
                            name="article_title"
            ...
            <div class="articles-container grid grid-cols-1 lg:grid-cols-3 gap-4 p-5">
                <?php foreach ($articles as $article): ?>
                    <?php loadPartial('articleCard', ['article' => $article]); ?>
                <?php endforeach; ?>
            </div>
        </section>
